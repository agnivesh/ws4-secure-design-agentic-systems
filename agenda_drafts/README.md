...
Per-workstream agenda drafts generated by the `cosai-ws4-meeting-agenda` skill (see [`scripts/agents/cosai-ws4-meeting-agenda/SKILL.md`](../scripts/agents/cosai-ws4-meeting-agenda/SKILL.md)) before promotion to a GitHub Discussion.
