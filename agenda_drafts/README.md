...
Per-workstream agenda drafts generated by the `meeting-agenda` skill (see [`scripts/agents/meeting-agenda/SKILL.md`](../scripts/agents/meeting-agenda/SKILL.md)) before promotion to a GitHub Discussion.
...
- `workstream` — slug, matches a workstream column in the `meeting-agenda` skill
